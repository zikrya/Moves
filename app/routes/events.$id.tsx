...
export default function Event() {
  ...
  return (
    <div className="min-h-screen blue-back px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 your-component-container">
        <div className="lg:order-2">
          ...
          <div className="mt-4 flex flex-col items-center sm:flex-row sm:space-x-4">
            <button
              onClick={openModal}
              className="your-component-btn flex w-full sm:w-auto items-center justify-center rounded-md border border-transparent bg-purple-600 px-8 py-3 text-base font-medium text-white hover:bg-blue-700 mt-4 sm:mt-0"
            >
              View Tickets
            </button>
